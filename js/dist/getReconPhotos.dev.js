...
exports.getReconPhoto = getReconPhoto;

function getReconPhoto(objectiveName) {
  var imagesMap = {
    "Abbeville Drucat Airfield": ["Abbeville Drucat Airfield.jpg"],
    "Rouen Rail Yards": ["Rouen Rail Yards - Zone 1.jpg", "Rouen Rail Yards - Zone 2.jpg", "Rouen Rail Yards - Zone 3.jpg"],
    ...
    "Perche HFDF Testing Facility": ["Perch HFDF Testing Facility.jpg"] // Add more airfields and their images as needed
